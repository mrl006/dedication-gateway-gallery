...
export const Footer = () => {
  return <footer className="relative bg-black/40 backdrop-blur-md border-t border-white/20 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 py-16 relative">
        <div className="text-center space-y-8">
          ...
          <div className="flex flex-col md:flex-row justify-center items-center gap-8 text-white/80">
            <a href="https://web3decision.com" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 px-6 py-3 bg-white/5 hover:bg-white/10 border border-white/20 rounded-xl transition-all duration-300 hover:text-purple-300 backdrop-blur-sm shadow-lg hover:shadow-xl hover:-translate-y-1">
              <Globe className="w-5 h-5" />
              <span className="font-medium">web3decision.com</span>
            </a>
            
            <a href="mailto:contact@web3decision.com" className="flex items-center gap-3 px-6 py-3 bg-white/5 hover:bg-white/10 border border-white/20 rounded-xl transition-all duration-300 hover:text-cyan-300 backdrop-blur-sm shadow-lg hover:shadow-xl hover:-translate-y-1">
          ...
          <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6 inline-block shadow-lg">
            ...
            <p className="text-white/50 text-sm mt-2">© 2024 Web3 Decision . All rights reserved.</p>
          </div>
        </div>
      </div>
    </footer>;
